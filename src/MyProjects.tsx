    ...
    <div className='containerBackground p-5' id="myProjects">
      ...
      <div className="flex p-6 gap-7 text-white">
        <div className="flex-1/3">
          ...
          <p className="mt-4">A web app that I have created for my school project. You can access it <a href="https://bed-ca2-shanna024985.onrender.com">here</a>.</p>
        </div>
        <div className="flex-1/3">
          <img src={googleDriveImage} alt="googleDriveProject" className="h-auto w-full"/>
          <p className="mt-4">A web app which allows you to add the same set of files and folders into a google drive folder within a click of a button. You can access it <a href="https://google-drive-folder-creation.onrender.com">here</a>.</p>
        </div>
        <div className="flex-1/3 justify-center content-center flex flex-col">
          ...
          <p className="mt-4">An app to compare prices between different taxi apps for any routes you take</p>
        </div>
      </div>
    </div>
  )
